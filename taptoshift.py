...
# Custom THEME: Mushroom background, brown button, light-mode enforced
custom_css = """
<style>
body {
    background-color: #C8B9AB !important;  /* Mushroom */
    color: #2D2D2D !important;
}
button[kind="primary"] {
    background-color: #7A5C43 !important;  /* Dark Brown */
